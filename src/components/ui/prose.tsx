  ...
  return (
    <div
      className={cn(
        ...
        'prose-headings:scroll-mt-24 prose-headings:font-display prose-headings:tracking-tight prose-headings:text-ink',
        ...
        'prose-code:text-ink prose-code:font-mono prose-code:text-[0.875em] prose-code:before:content-none prose-code:after:content-none',
        // bg-surface, not bg-raised: the Shiki themes assume a surface-level ground,
        // and the light comment token only reached 4.33:1 against --raised.
        'prose-pre:border prose-pre:border-line prose-pre:bg-surface prose-pre:text-[0.85rem]',
